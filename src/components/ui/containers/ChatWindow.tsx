...
export default function ChatWindow({ messages, savedMessages, chatRef, onSaveBotMessage }: ChatWindowProps) {
  return (
    <div ref={chatRef} className="flex-1 overflow-y-auto px-6 pt-4 pb-32 max-w-2xl mx-auto w-full">
